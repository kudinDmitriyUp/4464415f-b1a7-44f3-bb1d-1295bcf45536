...
export const metadata: Metadata = {
  title: "BuilderCult - Growth Marketing for Indie Apps",
  description: "Your App Deserves More Than Hope. It Deserves Growth. Performance-driven content, UGC, and creator-led visibility for indie app founders.",
  keywords: "indie app marketing, app growth, mobile app marketing, UGC content, app conversion, indie developer marketing, app store optimization",
  openGraph: {
    title: "BuilderCult - Growth Marketing for Indie Apps",
    description: "Performance-driven content, UGC, and creator-led visibility for indie app founders. Get your free growth blueprint today.",
    siteName: "BuilderCult",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35P1LUXVDX6Oh3omy3F4fM78YAJ/uploaded-1763141891200-oymoxpjz.jpg",
      alt: "BuilderCult app growth dashboard"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "BuilderCult - Growth Marketing for Indie Apps",
    description: "Your App Deserves More Than Hope. It Deserves Growth.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35P1LUXVDX6Oh3omy3F4fM78YAJ/uploaded-1763141891200-oymoxpjz.jpg"]
  }
};
